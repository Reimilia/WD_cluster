	...
	: QMainWindow(parent)
{
	...
	renderingwidget_ = new RenderWidget(this);
	//setCentralWidget(renderingwidget_);

	setGeometry(300, 150, 1100, 790);
...
{
	action_new_ = new QAction(QIcon(":/MeshViewer/Resources/images/new.png"), tr("&New"), this);
	action_new_->setShortcut(QKeySequence::New);
	action_new_->setStatusTip(tr("Create a new file"));

	action_open_ = new QAction(QIcon(":/MeshViewer/Resources/images/open.png"), tr("&Open..."), this);
	action_open_->setShortcuts(QKeySequence::Open);
	action_open_->setStatusTip(tr("Open an existing file"));
	connect(action_open_, SIGNAL(triggered()), renderingwidget_, SLOT(ReadMesh()));

	action_save_ = new QAction(QIcon(":/MeshViewer/Resources/images/save.png"), tr("&Save"), this);
...
void MeshViewer::CreateToolBars()
{
...
void MeshViewer::CreateRenderGroup()
{
...
void MeshViewer::ShowMeshInfo(int npoint, int nedge, int nface)
{
